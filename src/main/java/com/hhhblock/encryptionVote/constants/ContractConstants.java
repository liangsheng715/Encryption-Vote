  ...
  static {
    try {
      PaillierPrecompiledAbi = org.apache.commons.io.IOUtils
          .toString(Thread.currentThread().getContextClassLoader().getResource("abi/PaillierPrecompiled.abi"));
      PaillierPrecompiledBinary = org.apache.commons.io.IOUtils
          .toString(Thread.currentThread().getContextClassLoader().getResource("bin/ecc/PaillierPrecompiled.bin"));
      PaillierPrecompiledGmBinary = org.apache.commons.io.IOUtils
          .toString(Thread.currentThread().getContextClassLoader().getResource("bin/sm/PaillierPrecompiled.bin"));
